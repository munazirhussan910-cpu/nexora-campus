...
class PdfService {
    static async generateBonafidePdf(data) {
        ...
        const filePath = path_1.default.join(env_1.config.storageDir, fileName);
        // Generate QR Code image for the verification URL
        const qrBuffer = await qrcode_1.default.toBuffer(data.verificationUrl, {
            width: 120,
            margin: 1,
            color: {
                dark: '#1e2230',
        ...
        return new Promise((resolve, reject) => {
            ...
            doc
                ...
                .fillColor('#1e2230')
                .lineGap(8)
                .text('This is to certify that Mr./Ms. ', 60, doc.y, { continued: true })
                .font('Helvetica-Bold')
                ...
                .font('Helvetica')
                .text(`, is a bona fide, regular student of this institution, currently pursuing the Bachelor of Technology (B.Tech) degree in `, { continued: true })
                .font('Helvetica-Bold')
            ...
            doc
                .font('Helvetica')
                .fontSize(12)
                .text(`This certificate is officially issued on the formal request of the student for the express purpose of: `, 60, doc.y, { continued: true })
                .font('Helvetica-Bold')
                .text(`${data.purpose}.`);
            doc.moveDown(1);
            doc
                ...
                .fontSize(10)
                .fillColor('#57607a')
                .text('According to institution records, the conduct and academic standing of the student have remained satisfactory throughout the term of study.');
            doc.moveDown(3);
            ...
            doc.fontSize(8).fillColor('#8c97ad').text(`Digital Verification URL: ${data.verificationUrl}`, 60, doc.page.height - 50, { align: 'center', width: doc.page.width - 120 });
            doc.end();
