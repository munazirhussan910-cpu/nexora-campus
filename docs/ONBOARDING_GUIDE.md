...
│   ├── ARCHITECTURE.md         # FSM & system architecture specification
│   ├── DATABASE.md             # Prisma models & relational schema
│   ├── DEMO.md                 # 3-minute hackathon evaluation script
│   ├── DEPLOYMENT.md           # Production cloud deployment guide
│   ├── ONBOARDING_GUIDE.md     # This onboarding walkthrough
│   └── screenshots/            # Application UI screenshots & assets
│
├── CONTRIBUTING.md             # Git branch conventions, PR rules & code standards
├── .gitignore                  # Production Git ignore configuration
├── render.yaml                 # Render Blueprint specification
└── package.json                # Root workspace orchestrator with setup shortcuts
```
...
### 2. Fast One-Step Installation
From the root directory:
```bash
npm run setup
```
*This installs all workspaces, generates the Prisma client, runs schema migrations, and seeds the SQLite demo database in a single command.*

### 3. Environment Variables
Verify the following files exist (templates provided):
